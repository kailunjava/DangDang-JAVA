...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<form action="${pageContext.request.contextPath }/userAction/emailCode" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<h4>
						...
						onclick="window.location.href='${pageContext.request.contextPath }/userAction/code'"/>
						<!--  <a href="${pageContext.request.contextPath }/userAction/code">
						获取邮箱验证码
						</a>	-->					
						 ${sessionScope.emailCode}
					</h4>
					<div class="mess">
					    <input type="hidden" value="<s:property value="#session.email"/>" name="user.email">
